...
// Query untuk mendapatkan jumlah berita
...
$sql_berita = "SELECT * FROM berita ORDER BY tanggal DESC LIMIT 1";
                ...
                <div class="container-fluid">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Jumlah Berita</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total ?> Berita</div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4 berita-terbaru">
                                ...
                                if ($result_berita->num_rows > 0) {
                                    while ($row = $result_berita->fetch_assoc()) {
                                        ...
                                        $isi_berita = htmlspecialchars_decode($row['isi_berita']);
                                        $gambar_berita = htmlspecialchars($row['gambar_berita']);
                                        $tanggal = htmlspecialchars($row['tanggal']);
                                        $penulis_berita = htmlspecialchars($row['penulis_berita']);
                                ?>
                                        <!-- Card Body -->
                                        <div class="card-body p-4">
                                            ...
                                            <div class="card-title">
                                                <h3><?= $judul_berita ?></h3>
                                                <p id="penulis-berita"><em><?= $penulis_berita ?> | <?= $tanggal ?></em></p>
                                            </div>
                                            <div class="dropdown-divider"></div>
                                            <div class="embed-16by9-wrapper my-2">
                                                <img src="img/uploads/<?= $gambar_berita ?>" alt="">
                                            </div>
                                            <article>
                                                <p><?= $isi_berita ?></p>
                                            </article>
                                            <div class="mt-4">
                                                ...
                                                <a class="btn btn-success btn-sm mr-2"
                                                    href="https://api.whatsapp.com/send?text=<?= urlencode($judul_berita . ' - https://example.com/berita.php?id=' . $row['id_berita']); ?>"
                                                    target="_blank">
                                                    <i class="fab fa-fw fa-whatsapp"></i> WhatsApp
                                                </a>

                                                <a class="btn btn-primary btn-sm mr-2"
                                                    href="https://www.facebook.com/sharer/sharer.php?u=<?= urlencode('https://example.com/berita.php?id=' . $row['id_berita']); ?>"
                                                    target="_blank">
